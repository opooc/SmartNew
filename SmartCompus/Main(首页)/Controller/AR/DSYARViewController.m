...
@interface DSYARViewController ()<ARSCNViewDelegate>
//AR视图：展示3D界面
...
@implementation DSYARViewController
...
-(void)initNode{
    ...
    // 地球贴图
    _earthNode.geometry.firstMaterial.diffuse.contents = @"ar/earth-diffuse-mini.jpg";
    _earthNode.geometry.firstMaterial.emission.contents = @"ar/earth-emissive-mini.jpg";
    _earthNode.geometry.firstMaterial.specular.contents = @"ar/earth-specular-mini.jpg";
    //月球贴图
    _moonNode.geometry.firstMaterial.diffuse.contents = @"ar/moon.jpg";
    //太阳贴图
    _sunNode.geometry.firstMaterial.multiply.contents = @"ar/sun.jpg";
    _sunNode.geometry.firstMaterial.diffuse.contents = @"ar/sun.jpg";
...
-(void)addOtherNode{
    ...
    cloudsNode.geometry.firstMaterial.transparent.contents = @"ar/cloudsTransparency.png";
    ...
    _sunHaloNode.geometry.firstMaterial.diffuse.contents = @"ar/sun-halo.png";
    ...
    earthOrbit.geometry.firstMaterial.diffuse.contents = @"ar/orbit.png";
